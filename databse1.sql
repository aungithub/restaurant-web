...
insert  into `res_drink`(`drink_id`,`drink_name`,`drink_vendor_id`,`drink_number`,`drink_unit_id`,`drink_price`,`drink_status_id`) values 
(1,'coke',NULL,343,6,45,1),
(2,'แป๊ปซี่',5,1,6,45,1),
(3,'น้ำเปล่า',NULL,21,2,10,1),
(4,'แตงโมปั่น',NULL,1,6,45,1),
(5,'dsdf',1,2,2,23,1),
(6,'dsdf',1,2,2,23,1),
(7,'dsdf',1,2,2,23,1),
(8,'dsdf',1,2,2,23,1),
...
(17,12,1,1,1,50,10,500,42,8,28,1),
(18,12,3,3,3,20,7,140,20,0,28,1),
...
CREATE TABLE `res_food` (
  ...
  CONSTRAINT `fk_food_kind` FOREIGN KEY (`food_kind_id`) REFERENCES `res_kind` (`kind_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
(1,'หกหกหฟ','0247785468','124ฟกหกหก',2),
(3,'สุปรานีเครื่องดื่ม','0288795487','12 อ.เมือง จ.นนทบุรี',2),
(4,'drinkky','0245877445','17/1 ต.ตลลาดขวัญ อ.เมือง จ.นนทบุรี 11000',1),
